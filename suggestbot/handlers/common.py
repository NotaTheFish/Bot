...
async def cmd_start(message: Message) -> None:
    ...
    if user_id in ADMIN_IDS:
        ...
        await message.answer(
            "🐾 <b>Муррчащего дня вам!</b>\n\n"
            "Чтобы вашу работу приняли, нужно:\n"
            "— скинуть саму работу (ИИ или срисовки не принимаем)\n"
            "— ваш юз\n"
            "— по желанию, ваш тгк, если он у вас есть\n\n"
            "Если возникнут вопросы, то поддержка с вами свяжется.",
